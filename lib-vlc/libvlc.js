...
export class MediaPlayer {
  ...
  // Audio track switching methods
  get_audio_track_count() {
    return this.module._libvlc_audio_get_track_count(this.media_player_ptr);
  }

  get_audio_track() {
    return this.module._libvlc_audio_get_track(this.media_player_ptr);
  }

  set_audio_track(track_id) {
    return this.module._libvlc_audio_set_track(this.media_player_ptr, track_id);
  }

  get_audio_track_description(track_id) {
    return this.module._libvlc_audio_get_track_description(this.media_player_ptr);
  }

  // Subtitle (SPU) track switching methods
  get_spu_count() {
    return this.module._libvlc_video_get_spu_count(this.media_player_ptr);
  }

  get_spu() {
    return this.module._libvlc_video_get_spu(this.media_player_ptr);
  }

  set_spu(spu_id) {
    return this.module._libvlc_video_set_spu(this.media_player_ptr, spu_id);
  }

  get_spu_description() {
    return this.module._libvlc_video_get_spu_description(this.media_player_ptr);
  }

  get_spu_delay() {
    return this.module._libvlc_video_get_spu_delay(this.media_player_ptr);
  }

  set_spu_delay(delay) {
    return this.module._libvlc_video_set_spu_delay(this.media_player_ptr, delay);
  }
}
